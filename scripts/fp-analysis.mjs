...
//
// Do not reimplement any detector in this file. A local `countAlerts()` with
// inlined thresholds produces numbers that describe the reimplementation rather
// than the system the papers describe, and such numbers cannot support a
// false-positive claim about it.
//
