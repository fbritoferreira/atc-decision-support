...
CORRECTED_WINDOWS = [
    ...
    "imc-2026-09-011824",
    # KJFK, four hours to 2026-09-02 09:24 local. 240 snapshots and every one
    # of them instrument conditions, which no earlier window achieved: the
    # previous best was 240 at Kennedy split 88 IFR against 152 marginal. It
    # forms no wake pair, so it adds instrument-condition exposure and no
    # contrast, which is the half of the comparison this project keeps having
    # to be reminded is a measurement too.
    "imc-2026-09-020105",
